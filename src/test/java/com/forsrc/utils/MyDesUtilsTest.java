...
public class MyDesUtilsTest {
    ...
    @Test
    public void test() throws IOException, DesException {
        DesKey aes = new DesKey();
        //System.out.println(aes.generateKey());
        //System.out.println(aes.generateIv());
        String msg = "abc123$%您好";
        String encrypt = MyDesUtils.encrypt(aes, msg);
        //System.out.println( new String(new BASE64Decoder().decodeBuffer(encrypt)));
        assertEquals(msg, MyDesUtils.decrypt(aes, encrypt));
